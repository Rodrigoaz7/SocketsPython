...
while 1:
  ...
  if capitalizedSentence == "OBTER TESTE.TXT":
  	arquivo = open('teste.txt')
  	connectionSocket.send(str.encode(arquivo.read())) # envia para o cliente o texto transformado
  else:
  	connectionSocket.send(str.encode("NAO EXISTE ESTE ARQUIVO"))
